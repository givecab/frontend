...
export function HistoryPanel({ isOpen, onClose, previousResults, measureUnit, analysisName }: HistoryPanelProps) {
  ...
  return (
    <div className="w-full lg:w-96 border border-gray-200 rounded-lg overflow-hidden bg-white shadow-lg">
      <div className="bg-[#204983] text-white p-4 flex items-center justify-between">
      ...
      <div className="p-3 bg-gray-50 border-b border-gray-200">
        ...
        <p className="text-sm font-semibold text-[#204983]">{analysisName}</p>
      </div>
        ...
        {sortedResults.length === 0 ? (
          ...
          sortedResults.map((result, index) => (
            <div
              ...
              className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 border-l-4 border-l-[#204983]"
            >
              <div className="flex items-center justify-between mb-3">
                <Badge variant="outline" className="bg-gray-50 text-xs font-medium">
              ...
              <div className="mb-3 pb-3 border-b border-gray-100">
                <p className="text-2xl font-bold text-[#204983]">
                  {result.value} <span className="text-sm font-normal text-gray-600">{measureUnit}</span>
                </p>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-1 text-xs text-gray-600">
                  ...
                  <span>{result.created_by.username}</span>
                </div>
              </div>
            </div>
          ))
